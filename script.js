...
class ToggleButtonShape extends DynamicDarkMode_Constants {
  toggleElm = undefined;
  ...
  getInputElement() {
    ...
    const selector = `#${this.elmId} input[type='checkbox']`;
...
class ToggleHistoryManager extends DynamicDarkMode_Constants {
  saveState(state) {
...
class ToggleAction extends DynamicDarkMode_Constants {
